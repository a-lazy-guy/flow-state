...
# Use relative path to avoid non-ASCII characters in the script source code
file_path = os.path.join('app', 'web', 'templates', 'index.html')
...
def fix_encoding():
    ...
    # If GBK fails, try UTF-8 with error ignore
    if content is None:
        try:
