...
# HTML Content without Hero Card, UTF-8 ready
        ...
        <div class='left-panel' id='left-panel'>
            ...
            <div class='search-bar-container' id='search-bar'>
                <div class='search-input-wrapper'>
                    ...
                    <input type='text' class='search-input' id='history-search-input' placeholder='搜索浏览记录...' oninput='filterHistory()'>
                </div>
            </div>
            ...
            <div class='history-container'>
                <div class='history-header'>
                    <span>近七天浏览记录</span>
                    <span style='font-size: 12px; font-weight: normal; color: #789035;'>数据来源: 本地监控</span>
                </div>
                <div class='history-list' id='history-list'>
                    <!-- JS 动态填充 -->
                    <div style='text-align: center; color: #789035; margin-top: 50px;'>正在加载数据...</div>
                </div>
            </div>
        </div>
    ...
    <div class='modal-overlay' id='settings-modal'>
        <div class='settings-modal'>
            ...
            <div class='setting-item'>
                <div class='setting-label'>自动记录浏览数据</div>
                <label class='switch'>
            ...
            <div class='setting-item'>
                <div class='setting-label'>深色模式 (暂不可用)</div>
                <label class='switch'>
            ...
            <div style='margin-top: 20px; text-align: right;'>
                <button onclick='toggleSettings()' style='padding: 8px 20px; background: var(--color-green-dark); color: white; border: none; border-radius: 6px; cursor: pointer;'>保存</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        async function loadHistory() {
            ...
            try {
                ...
                listEl.innerHTML = "<div style='text-align: center; color: red;'>加载失败</div>";
            }
        }
        ...
        function renderHistory(data) {
            ...
            if (!data || data.length === 0) {
                listEl.innerHTML = "<div style='text-align: center; color: #789035;'>暂无浏览记录</div>";
                return;
            }
            ...
            listEl.innerHTML = data.map(item => {
                ...
                const time = item.timestamp ? item.timestamp.split(' ')[1].substring(0, 5) : '--:--'; // Extract HH:MM
